...
export default async function BloguePostPage({ params }: Params) {
  ...
  const articleJsonLd = {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://orianasolutions.ca/icon.png",
      },
    },
    url: `https://orianasolutions.ca/blogue/${post.slug}`,
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://orianasolutions.ca/blogue/${post.slug}`,
    },
  };
      ...
      <div className="w-full relative overflow-hidden bg-primary-light">
        ...
        <div className="relative max-w-5xl mx-auto px-6 pt-16 pb-20 md:pt-24 md:pb-28">
          ...
          <div className="flex items-center gap-2 text-xs text-black/40 mb-10">
            <Link href="/blogue" className="hover:text-primary transition-colors">Blogue</Link>
            <span>/</span>
